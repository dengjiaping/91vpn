...
package com.dmtec.a91jiasu.utils;
...
public final class Constants
{
	 ...
	 */
	public static final String VPN_PROFILES_CHANGED = "com.dmtec.a91jiasu.VPN_PROFILES_CHANGED";

	/**
	 * Used in the intent above to notify about edits or inserts of a VPN profile (long)
	 */
	public static final String VPN_PROFILES_SINGLE = "com.dmtec.a91jiasu.VPN_PROFILES_SINGLE";

	/**
	 * Used in the intent above to notify about the deletion of multiple VPN profiles (array of longs)
	 */
	public static final String VPN_PROFILES_MULTIPLE = "com.dmtec.a91jiasu.VPN_PROFILES_MULTIPLE";
